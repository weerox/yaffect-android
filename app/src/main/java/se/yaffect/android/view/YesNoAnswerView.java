...
public class YesNoAnswerView extends AnswerView {
    ...
    private void unselectAll() {
        if (state == State.NO) {
            ...
            iconNo.setColorFilter(ContextCompat.getColor(getContext(), R.color.yes)); // set tint
        }
