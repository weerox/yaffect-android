...
public class MultichoiceAnswerView extends AnswerView {
    ...
    private void init(Context context) {
        ...
        layoutInflater.inflate(R.layout.view_answer_multichoice, this, true);
    ...
    public void addAlternative(String alternative) {
        ...
        CheckBox checkBox = (CheckBox) layoutInflater.inflate(R.layout.item_multichoice, listAlternatives, false);
